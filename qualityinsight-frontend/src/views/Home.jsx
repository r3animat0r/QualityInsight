        ...
        <Card variant="outlined" classes={{ root: "qi-card" }}>
          <CardContent classes={{ root: "card-content" }}>
            ...
            <Typography variant="body1" classes={{ body1: "content" }}>
              <p>
                Articles on Wikipedia are rated and receive a grade (Stub,
                Start, C, B, GA, FA). This tool will explain grading of articles
                and on what they are based on, making it more transparent what
                an article might be lacking or what makes it so good.
              </p>
              <p>
                The Visualizations are made with LIME. LIME stands for Local
                Interpretable Model-Agnostic Explanations and it can uncover
                what happens inside Machine Learning models.
              </p>
            </Typography>
          </CardContent>
        </Card>
